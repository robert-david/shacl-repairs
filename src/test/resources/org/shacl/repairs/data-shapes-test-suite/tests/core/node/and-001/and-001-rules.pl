...
sh_and("ex_Rectangle","node1g835dclmx273") .
rdf_first("node1g835dclmx273","node1g835dclmx274") .
sh_property("node1g835dclmx274","node1g835dclmx275") .
sh_path("node1g835dclmx275","ex_width") .
sh_minCount("node1g835dclmx275","1") .
xsd_integer("1") .
rdf_rest("node1g835dclmx273","node1g835dclmx276") .
rdf_first("node1g835dclmx276","node1g835dclmx277") .
sh_property("node1g835dclmx277","node1g835dclmx278") .
sh_path("node1g835dclmx278","ex_height") .
sh_minCount("node1g835dclmx278","1") .
rdf_rest("node1g835dclmx276","rdf_nil") .
ex_Rectangle("ex_ValidRectangle1") .
ex_height("ex_ValidRectangle1","3") .
ex_width("ex_ValidRectangle1","2") .
mf_Manifest("http://repairs.shacl.org") .
mf_entries("http://repairs.shacl.org","node1g835dclmx279") .
rdf_first("node1g835dclmx279","http://repairs.shacl.org/and_001") .
rdf_rest("node1g835dclmx279","rdf_nil") .
...
mf_action("http://repairs.shacl.org/and_001","node1g835dclmx280") .
sht_dataGraph("node1g835dclmx280","http://repairs.shacl.org") .
sht_shapesGraph("node1g835dclmx280","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/and_001","node1g835dclmx281") .
sh_ValidationReport("node1g835dclmx281") .
sh_conforms("node1g835dclmx281","false") .
xsd_boolean("false") .
sh_result("node1g835dclmx281","node1g835dclmx282") .
sh_ValidationResult("node1g835dclmx282") .
sh_focusNode("node1g835dclmx282","ex_InvalidRectangle1") .
sh_resultSeverity("node1g835dclmx282","sh_Violation") .
sh_sourceConstraintComponent("node1g835dclmx282","sh_AndConstraintComponent") .
sh_sourceShape("node1g835dclmx282","ex_Rectangle") .
sh_value("node1g835dclmx282","ex_InvalidRectangle1") .
sh_result("node1g835dclmx281","node1g835dclmx283") .
sh_ValidationResult("node1g835dclmx283") .
sh_focusNode("node1g835dclmx283","ex_InvalidRectangle2") .
sh_resultSeverity("node1g835dclmx283","sh_Violation") .
sh_sourceConstraintComponent("node1g835dclmx283","sh_AndConstraintComponent") .
sh_sourceShape("node1g835dclmx283","ex_Rectangle") .
sh_value("node1g835dclmx283","ex_InvalidRectangle2") .
...
node1g835dclmx286_(X,"t*"):-s0_(X,"t*") .
node1g835dclmx286_(X,"f"):-s0_(X,"f") .

% sh:minCount 1 for node1g835dclmx286
s1_(X,"t*"):-node1g835dclmx286_(X,"t*") .
ex_width_(X,@new(s1,X,ex_width,1..1),"t"):-choose(s1,X,ex_width,1) .
choose(s1,X,ex_width,1);choose(s1,X,ex_width,0):-s1_(X,"t*") .
(C-0) {ex_width_(X,Y,"f"):ex_width(X,Y);s2_(Y,"f"):ex_width_(X,Y,"t*"),not ex_width_(X,Y,"f")} (C-0):-s1_(X,"f"),#count {Y:ex_width_(X,Y,"t*")}=C,C>0 .
1 {s2_(Y,"t*"):ex_width_(X,Y,"t**")} 1:-s1_(X,"t*") .


% universal for node1g835dclmx286
s3_(X,"t*"):-node1g835dclmx286_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
ex_width_(X,@new(s4,X,ex_width,1..1),"t"):-choose(s4,X,ex_width,1) .
choose(s4,X,ex_width,1);choose(s4,X,ex_width,0):-s4_(X,"t*") .
(C-0) {ex_width_(X,Y,"f"):ex_width(X,Y);s5_(Y,"f"):ex_width_(X,Y,"t*"),not ex_width_(X,Y,"f")} (C-0):-s4_(X,"f"),#count {Y:ex_width_(X,Y,"t*")}=C,C>0 .
1 {s5_(Y,"t*"):ex_width_(X,Y,"t**")} 1:-s4_(X,"t*") .
s6_(X,"f"):-s5_(X,"t*") .
s6_(X,"t*"):-s5_(X,"f") .


s1_(X,"f");s3_(X,"f"):-node1g835dclmx286_(X,"f") .
s7_(X,"t*"):-ex_Rectangle_(X,"t*") .
node1g835dclmx289_(X,"t*"):-s7_(X,"t*") .
node1g835dclmx289_(X,"f"):-s7_(X,"f") .

% sh:minCount 1 for node1g835dclmx289
s8_(X,"t*"):-node1g835dclmx289_(X,"t*") .
...
% universal for node1g835dclmx289
s10_(X,"t*"):-node1g835dclmx289_(X,"t*") .
s11_(X,"f"):-s10_(X,"t*") .
s11_(X,"t*"):-s10_(X,"f") .
...
s8_(X,"f");s10_(X,"f"):-node1g835dclmx289_(X,"f") .
