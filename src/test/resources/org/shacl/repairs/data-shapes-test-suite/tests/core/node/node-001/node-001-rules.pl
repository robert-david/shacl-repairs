...
sh_node("ex_TestClass","node1hgobhchgx6") .
sh_class("node1hgobhchgx6","ex_OtherClass") .
...
mf_entries("http://repairs.shacl.org","node1hgobhchgx7") .
rdf_first("node1hgobhchgx7","http://repairs.shacl.org/node_001") .
rdf_rest("node1hgobhchgx7","rdf_nil") .
...
mf_action("http://repairs.shacl.org/node_001","node1hgobhchgx8") .
sht_dataGraph("node1hgobhchgx8","http://repairs.shacl.org") .
sht_shapesGraph("node1hgobhchgx8","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/node_001","node1hgobhchgx9") .
sh_ValidationReport("node1hgobhchgx9") .
sh_conforms("node1hgobhchgx9","false") .
xsd_boolean("false") .
sh_result("node1hgobhchgx9","node1hgobhchgx10") .
sh_ValidationResult("node1hgobhchgx10") .
sh_focusNode("node1hgobhchgx10","ex_InvalidInstance") .
sh_resultSeverity("node1hgobhchgx10","sh_Violation") .
sh_sourceConstraintComponent("node1hgobhchgx10","sh_NodeConstraintComponent") .
sh_sourceShape("node1hgobhchgx10","ex_TestClass") .
sh_value("node1hgobhchgx10","ex_InvalidInstance") .
