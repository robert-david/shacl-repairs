...
sh_path("ex_s1","node1hdcdgs0ox149") .
rdf_first("node1hdcdgs0ox149","ex_p") .
rdf_rest("node1hdcdgs0ox149","node1hdcdgs0ox150") .
rdf_first("node1hdcdgs0ox150","ex_q") .
rdf_rest("node1hdcdgs0ox150","rdf_nil") .
sh_inversePath("node1hdcdgs0ox149","ex_p") .
sh_class("ex_s1","ex_C") .
mf_Manifest("http://repairs.shacl.org") .
mf_entries("http://repairs.shacl.org","node1hdcdgs0ox151") .
rdf_first("node1hdcdgs0ox151","http://repairs.shacl.org/path_strange_001") .
rdf_rest("node1hdcdgs0ox151","rdf_nil") .
...
mf_action("http://repairs.shacl.org/path_strange_001","node1hdcdgs0ox152") .
sht_dataGraph("node1hdcdgs0ox152","http://repairs.shacl.org") .
sht_shapesGraph("node1hdcdgs0ox152","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/path_strange_001","node1hdcdgs0ox153") .
sh_ValidationReport("node1hdcdgs0ox153") .
sh_conforms("node1hdcdgs0ox153","false") .
xsd_boolean("false") .
sh_result("node1hdcdgs0ox153","node1hdcdgs0ox154") .
sh_ValidationResult("node1hdcdgs0ox154") .
sh_focusNode("node1hdcdgs0ox154","ex_j") .
sh_value("node1hdcdgs0ox154","ex_jpq") .
sh_resultPath("node1hdcdgs0ox154","node1hdcdgs0ox155") .
rdf_first("node1hdcdgs0ox155","ex_p") .
rdf_rest("node1hdcdgs0ox155","node1hdcdgs0ox156") .
rdf_first("node1hdcdgs0ox156","ex_q") .
rdf_rest("node1hdcdgs0ox156","rdf_nil") .
sh_resultSeverity("node1hdcdgs0ox154","sh_Violation") .
sh_sourceConstraintComponent("node1hdcdgs0ox154","sh_ClassConstraintComponent") .
sh_sourceShape("node1hdcdgs0ox154","ex_s1") .
