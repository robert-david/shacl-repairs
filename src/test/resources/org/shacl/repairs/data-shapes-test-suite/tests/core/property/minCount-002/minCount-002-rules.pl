...
sh_property("ex_TestShape","node1hmcimj6lx339") .
sh_path("node1hmcimj6lx339","ex_property") .
sh_minCount("node1hmcimj6lx339","0") .
xsd_integer("0") .
sh_name("node1hmcimj6lx339","property") .
xsd_string("property") .
sh_targetNode("ex_TestShape","ex_ValidResource1") .
rdfs_Resource("ex_ValidResource1") .
mf_Manifest("http://repairs.shacl.org") .
mf_entries("http://repairs.shacl.org","node1hmcimj6lx340") .
rdf_first("node1hmcimj6lx340","http://repairs.shacl.org/minCount_002") .
rdf_rest("node1hmcimj6lx340","rdf_nil") .
...
mf_action("http://repairs.shacl.org/minCount_002","node1hmcimj6lx341") .
sht_dataGraph("node1hmcimj6lx341","http://repairs.shacl.org") .
sht_shapesGraph("node1hmcimj6lx341","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/minCount_002","node1hmcimj6lx342") .
sh_ValidationReport("node1hmcimj6lx342") .
sh_conforms("node1hmcimj6lx342","true") .
xsd_boolean("true") .
...
node1hmcimj6lx343_st_(X,Y,"t*"):-node1hmcimj6lx343_(X,_),ex_property_(X,Y,"t*") .

% Repair Rules

node1hmcimj6lx343_(X,"t*"):-ex_TestShape_(X,"t*") .
node1hmcimj6lx343_(X,"f"):-ex_TestShape_(X,"f") .

% sh:minCount 0 for node1hmcimj6lx343
s0_(X,"t*"):-node1hmcimj6lx343_(X,"t*") .
...
% universal for node1hmcimj6lx343
s2_(X,"t*"):-node1hmcimj6lx343_(X,"t*") .
s3_(X,"f"):-s2_(X,"t*") .
s3_(X,"t*"):-s2_(X,"f") .
...
s0_(X,"f");s2_(X,"f"):-node1hmcimj6lx343_(X,"f") .

% Interpretation Rules

ex_property_(X,Y,"t**"):-ex_property_(X,Y,"t*"),not ex_property_(X,Y,"f") .
node1hmcimj6lx343_st_(X,Y,"t**"):-ex_property_(X,Y,"t**"),node1hmcimj6lx343_st_(X,Y,"t*"),not node1hmcimj6lx343_st_(X,Y,"f") .
