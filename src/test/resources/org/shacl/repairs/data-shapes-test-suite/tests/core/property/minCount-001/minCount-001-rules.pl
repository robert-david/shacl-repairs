...
sh_minCount("ex_PersonShape-firstName","1") .
xsd_integer("1") .
...
mf_entries("http://repairs.shacl.org","bnode_0465bff3129e4f3db89e6d0321ce7388351") .
rdf_first("bnode_0465bff3129e4f3db89e6d0321ce7388351","http://repairs.shacl.org/minCount-001") .
rdf_rest("bnode_0465bff3129e4f3db89e6d0321ce7388351","rdf_nil") .
sht_Validate("http://repairs.shacl.org/minCount-001") .
rdfs_label("http://repairs.shacl.org/minCount-001","Test of sh:minCount at property shape 001") .
xsd_string("Test of sh:minCount at property shape 001") .
mf_action("http://repairs.shacl.org/minCount-001","bnode_0465bff3129e4f3db89e6d0321ce7388352") .
sht_dataGraph("bnode_0465bff3129e4f3db89e6d0321ce7388352","http://repairs.shacl.org") .
sht_shapesGraph("bnode_0465bff3129e4f3db89e6d0321ce7388352","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/minCount-001","bnode_0465bff3129e4f3db89e6d0321ce7388353") .
sh_ValidationReport("bnode_0465bff3129e4f3db89e6d0321ce7388353") .
sh_conforms("bnode_0465bff3129e4f3db89e6d0321ce7388353","false") .
xsd_boolean("false") .
sh_result("bnode_0465bff3129e4f3db89e6d0321ce7388353","bnode_0465bff3129e4f3db89e6d0321ce7388354") .
sh_ValidationResult("bnode_0465bff3129e4f3db89e6d0321ce7388354") .
sh_focusNode("bnode_0465bff3129e4f3db89e6d0321ce7388354","ex_InvalidPerson") .
sh_resultPath("bnode_0465bff3129e4f3db89e6d0321ce7388354","ex_firstName") .
sh_resultSeverity("bnode_0465bff3129e4f3db89e6d0321ce7388354","sh_Violation") .
sh_sourceConstraintComponent("bnode_0465bff3129e4f3db89e6d0321ce7388354","sh_MinCountConstraintComponent") .
sh_sourceShape("bnode_0465bff3129e4f3db89e6d0321ce7388354","ex_PersonShape-firstName") .
mf_status("http://repairs.shacl.org/minCount-001","sht_approved") .
...
s8_(X,"f");s10_(X,"f"):-ex_PersonShape__firstName_(X,"f") .
s14_(X,"t*"):-ex_PersonShape_(X,"t*") .
ex_PersonShape__firstName_(X,"t*"):-s14_(X,"t*") .
ex_PersonShape__firstName_(X,"f"):-s14_(X,"f") .

% sh:minCount 1 for ex_PersonShape__firstName
s15_(X,"t*"):-ex_PersonShape__firstName_(X,"t*") .
...
s17_(X,"t*"):-ex_PersonShape__firstName_(X,"t*") .
s18_(X,"f"):-s17_(X,"t*") .
s18_(X,"t*"):-s17_(X,"f") .
...
s15_(X,"f");s17_(X,"f"):-ex_PersonShape__firstName_(X,"f") .
s21_(X,"t*"):-ex_PersonShape_(X,"t*") .
ex_PersonShape__firstName_(X,"t*"):-s21_(X,"t*") .
ex_PersonShape__firstName_(X,"f"):-s21_(X,"f") .

s22_(X,"t*"):-ex_PersonShape__firstName_(X,"t*") .
...
s24_(X,"t*"):-ex_PersonShape__firstName_(X,"t*") .
s25_(X,"f"):-s24_(X,"t*") .
s25_(X,"t*"):-s24_(X,"f") .
...
s22_(X,"f");s24_(X,"f"):-ex_PersonShape__firstName_(X,"f") .
