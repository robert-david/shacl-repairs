...
mf_entries("http://repairs.shacl.org","node1h0oc2cvkx1166") .
rdf_first("node1h0oc2cvkx1166","http://repairs.shacl.org/minCount_001") .
rdf_rest("node1h0oc2cvkx1166","rdf_nil") .
...
mf_action("http://repairs.shacl.org/minCount_001","node1h0oc2cvkx1167") .
sht_dataGraph("node1h0oc2cvkx1167","http://repairs.shacl.org") .
sht_shapesGraph("node1h0oc2cvkx1167","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/minCount_001","node1h0oc2cvkx1168") .
sh_ValidationReport("node1h0oc2cvkx1168") .
sh_conforms("node1h0oc2cvkx1168","false") .
xsd_boolean("false") .
sh_result("node1h0oc2cvkx1168","node1h0oc2cvkx1169") .
sh_ValidationResult("node1h0oc2cvkx1169") .
sh_focusNode("node1h0oc2cvkx1169","ex_InvalidPerson") .
sh_resultPath("node1h0oc2cvkx1169","ex_firstName") .
sh_resultSeverity("node1h0oc2cvkx1169","sh_Violation") .
sh_sourceConstraintComponent("node1h0oc2cvkx1169","sh_MinCountConstraintComponent") .
sh_sourceShape("node1h0oc2cvkx1169","ex_PersonShape_firstName") .
...
(C-0) {ex_PersonShape_firstName_st_(X,Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*");s5_(Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*"),not ex_PersonShape_firstName_st_(X,Y,"f")} (C-0):-s4_(X,"f"),#count {Y:ex_PersonShape_firstName_st_(X,Y,"t*")}=C,C>0 .
ex_firstName_(X,Y,"f"):-s4_(X,"f"),ex_firstName_(X,Y,"t*"),ex_PersonShape_firstName_st_(X,Y,"f") .
1 {s5_(Y,"t*"):ex_PersonShape_firstName_st_(X,Y,"t**")} 1:-s4_(X,"t*") .
s6_(X,"f"):-s5_(X,"t*") .
s6_(X,"t*"):-s5_(X,"f") .
...
(C-0) {ex_PersonShape_firstName_st_(X,Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*");s9_(Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*"),not ex_PersonShape_firstName_st_(X,Y,"f")} (C-0):-s8_(X,"f"),#count {Y:ex_PersonShape_firstName_st_(X,Y,"t*")}=C,C>0 .
ex_firstName_(X,Y,"f"):-s8_(X,"f"),ex_firstName_(X,Y,"t*"),ex_PersonShape_firstName_st_(X,Y,"f") .
1 {s9_(Y,"t*"):ex_PersonShape_firstName_st_(X,Y,"t**")} 1:-s8_(X,"t*") .
...
1 {s12_(Y,"t*"):ex_PersonShape_firstName_st_(X,Y,"t**")} 1:-s11_(X,"t*") .
s13_(X,"f"):-s12_(X,"t*") .
s13_(X,"t*"):-s12_(X,"f") .
...
(C-0) {ex_PersonShape_firstName_st_(X,Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*");s16_(Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*"),not ex_PersonShape_firstName_st_(X,Y,"f")} (C-0):-s15_(X,"f"),#count {Y:ex_PersonShape_firstName_st_(X,Y,"t*")}=C,C>0 .
ex_firstName_(X,Y,"f"):-s15_(X,"f"),ex_firstName_(X,Y,"t*"),ex_PersonShape_firstName_st_(X,Y,"f") .
1 {s16_(Y,"t*"):ex_PersonShape_firstName_st_(X,Y,"t**")} 1:-s15_(X,"t*") .
...
1 {s19_(Y,"t*"):ex_PersonShape_firstName_st_(X,Y,"t**")} 1:-s18_(X,"t*") .
s20_(X,"f"):-s19_(X,"t*") .
s20_(X,"t*"):-s19_(X,"f") .
...
(C-0) {ex_PersonShape_firstName_st_(X,Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*");s23_(Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*"),not ex_PersonShape_firstName_st_(X,Y,"f")} (C-0):-s22_(X,"f"),#count {Y:ex_PersonShape_firstName_st_(X,Y,"t*")}=C,C>0 .
ex_firstName_(X,Y,"f"):-s22_(X,"f"),ex_firstName_(X,Y,"t*"),ex_PersonShape_firstName_st_(X,Y,"f") .
0 {s23_(Y,"t*"):ex_PersonShape_firstName_st_(X,Y,"t**")} 0:-s22_(X,"t*") .
...
(C-0) {ex_PersonShape_firstName_st_(X,Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*");s26_(Y,"f"):ex_PersonShape_firstName_st_(X,Y,"t*"),not ex_PersonShape_firstName_st_(X,Y,"f")} (C-0):-s25_(X,"f"),#count {Y:ex_PersonShape_firstName_st_(X,Y,"t*")}=C,C>0 .
ex_firstName_(X,Y,"f"):-s25_(X,"f"),ex_firstName_(X,Y,"t*"),ex_PersonShape_firstName_st_(X,Y,"f") .
1 {s26_(Y,"t*"):ex_PersonShape_firstName_st_(X,Y,"t**")} 1:-s25_(X,"t*") .
s27_(X,"f"):-s26_(X,"t*") .
s27_(X,"t*"):-s26_(X,"f") .
