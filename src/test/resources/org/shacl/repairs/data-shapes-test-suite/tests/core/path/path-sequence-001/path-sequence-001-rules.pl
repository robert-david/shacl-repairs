...
sh_path("ex_TestShape","node1hdcdgs0ox66") .
rdf_first("node1hdcdgs0ox66","ex_property1") .
rdf_rest("node1hdcdgs0ox66","node1hdcdgs0ox67") .
rdf_first("node1hdcdgs0ox67","ex_property2") .
rdf_rest("node1hdcdgs0ox67","rdf_nil") .
...
mf_entries("http://repairs.shacl.org","node1hdcdgs0ox68") .
rdf_first("node1hdcdgs0ox68","http://repairs.shacl.org/path_sequence_001") .
rdf_rest("node1hdcdgs0ox68","rdf_nil") .
...
mf_action("http://repairs.shacl.org/path_sequence_001","node1hdcdgs0ox69") .
sht_dataGraph("node1hdcdgs0ox69","http://repairs.shacl.org") .
sht_shapesGraph("node1hdcdgs0ox69","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/path_sequence_001","node1hdcdgs0ox70") .
sh_ValidationReport("node1hdcdgs0ox70") .
sh_conforms("node1hdcdgs0ox70","false") .
xsd_boolean("false") .
sh_result("node1hdcdgs0ox70","node1hdcdgs0ox71") .
sh_ValidationResult("node1hdcdgs0ox71") .
sh_focusNode("node1hdcdgs0ox71","ex_InvalidResource1") .
sh_resultPath("node1hdcdgs0ox71","node1hdcdgs0ox72") .
rdf_first("node1hdcdgs0ox72","ex_property1") .
rdf_rest("node1hdcdgs0ox72","node1hdcdgs0ox73") .
rdf_first("node1hdcdgs0ox73","ex_property2") .
rdf_rest("node1hdcdgs0ox73","rdf_nil") .
sh_resultSeverity("node1hdcdgs0ox71","sh_Violation") .
sh_sourceConstraintComponent("node1hdcdgs0ox71","sh_MinCountConstraintComponent") .
sh_sourceShape("node1hdcdgs0ox71","ex_TestShape") .
sh_result("node1hdcdgs0ox70","node1hdcdgs0ox74") .
sh_ValidationResult("node1hdcdgs0ox74") .
sh_focusNode("node1hdcdgs0ox74","ex_InvalidResource2") .
sh_resultPath("node1hdcdgs0ox74","node1hdcdgs0ox75") .
rdf_first("node1hdcdgs0ox75","ex_property1") .
rdf_rest("node1hdcdgs0ox75","node1hdcdgs0ox76") .
rdf_first("node1hdcdgs0ox76","ex_property2") .
rdf_rest("node1hdcdgs0ox76","rdf_nil") .
sh_resultSeverity("node1hdcdgs0ox74","sh_Violation") .
sh_sourceConstraintComponent("node1hdcdgs0ox74","sh_MinCountConstraintComponent") .
sh_sourceShape("node1hdcdgs0ox74","ex_TestShape") .
...
ex_TestShape_st_(X,X1,"t**"):-ex_TestShape_st_(X,Y,"t*"),not ex_TestShape_st_(X,Y,"f"),ex_property1_(X,X0,"t**"),ex_property2_(X0,X1,"t**") .
