...
ex_p_inv_(X,X0,"f");ex_p_inv_(X0,X1,"f"):-ex_p_inv_(X,X0,"t*"),ex_p_inv_(X0,X1,"t*"),ex_s1_st_(X,X1,"f") .
...
ex_p_inv_(X,X0,"f");ex_p_inv_(X0,X1,"f"):-ex_p_inv_(X,X0,"t*"),ex_p_inv_(X0,X1,"t*"),ex_s2_st_(X,X1,"f") .
