...
sh_or("ex_AddressShape_address","node1h0oc2cvkx1017") .
rdf_first("node1h0oc2cvkx1017","node1h0oc2cvkx1018") .
sh_datatype("node1h0oc2cvkx1018","xsd_string") .
rdf_rest("node1h0oc2cvkx1017","node1h0oc2cvkx1019") .
rdf_first("node1h0oc2cvkx1019","node1h0oc2cvkx1020") .
sh_class("node1h0oc2cvkx1020","ex_Address") .
rdf_rest("node1h0oc2cvkx1019","rdf_nil") .
...
ex_address("ex_ValidResource2","node1h0oc2cvkx1021") .
ex_Address("node1h0oc2cvkx1021") .
mf_Manifest("http://repairs.shacl.org") .
mf_entries("http://repairs.shacl.org","node1h0oc2cvkx1022") .
rdf_first("node1h0oc2cvkx1022","http://repairs.shacl.org/or_001") .
rdf_rest("node1h0oc2cvkx1022","rdf_nil") .
...
mf_action("http://repairs.shacl.org/or_001","node1h0oc2cvkx1023") .
sht_dataGraph("node1h0oc2cvkx1023","http://repairs.shacl.org") .
sht_shapesGraph("node1h0oc2cvkx1023","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/or_001","node1h0oc2cvkx1024") .
sh_ValidationReport("node1h0oc2cvkx1024") .
sh_conforms("node1h0oc2cvkx1024","false") .
xsd_boolean("false") .
sh_result("node1h0oc2cvkx1024","node1h0oc2cvkx1025") .
sh_ValidationResult("node1h0oc2cvkx1025") .
sh_focusNode("node1h0oc2cvkx1025","ex_InvalidResource1") .
sh_resultPath("node1h0oc2cvkx1025","ex_address") .
sh_resultSeverity("node1h0oc2cvkx1025","sh_Violation") .
sh_sourceConstraintComponent("node1h0oc2cvkx1025","sh_OrConstraintComponent") .
sh_sourceShape("node1h0oc2cvkx1025","ex_AddressShape_address") .
sh_value("node1h0oc2cvkx1025","true") .
...
(C-0) {ex_AddressShape_address_st_(X,Y,"f"):ex_AddressShape_address_st_(X,Y,"t*");s6_(Y,"f"):ex_AddressShape_address_st_(X,Y,"t*"),not ex_AddressShape_address_st_(X,Y,"f")} (C-0):-s5_(X,"f"),#count {Y:ex_AddressShape_address_st_(X,Y,"t*")}=C,C>0 .
ex_address_(X,Y,"f"):-s5_(X,"f"),ex_address_(X,Y,"t*"),ex_AddressShape_address_st_(X,Y,"f") .
1 {s6_(Y,"t*"):ex_AddressShape_address_st_(X,Y,"t**")} 1:-s5_(X,"t*") .
s7_(X,"f"):-s6_(X,"t*") .
s7_(X,"t*"):-s6_(X,"f") .
