...
sh_or("ex_AddressShape_address","node1hgobhchgx258") .
rdf_first("node1hgobhchgx258","node1hgobhchgx259") .
sh_datatype("node1hgobhchgx259","xsd_string") .
rdf_rest("node1hgobhchgx258","node1hgobhchgx260") .
rdf_first("node1hgobhchgx260","node1hgobhchgx261") .
sh_class("node1hgobhchgx261","ex_Address") .
rdf_rest("node1hgobhchgx260","rdf_nil") .
...
ex_address("ex_ValidResource2","node1hgobhchgx262") .
ex_Address("node1hgobhchgx262") .
mf_Manifest("http://repairs.shacl.org") .
mf_entries("http://repairs.shacl.org","node1hgobhchgx263") .
rdf_first("node1hgobhchgx263","http://repairs.shacl.org/or_001") .
rdf_rest("node1hgobhchgx263","rdf_nil") .
...
mf_action("http://repairs.shacl.org/or_001","node1hgobhchgx264") .
sht_dataGraph("node1hgobhchgx264","http://repairs.shacl.org") .
sht_shapesGraph("node1hgobhchgx264","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/or_001","node1hgobhchgx265") .
sh_ValidationReport("node1hgobhchgx265") .
sh_conforms("node1hgobhchgx265","false") .
xsd_boolean("false") .
sh_result("node1hgobhchgx265","node1hgobhchgx266") .
sh_ValidationResult("node1hgobhchgx266") .
sh_focusNode("node1hgobhchgx266","ex_InvalidResource1") .
sh_resultPath("node1hgobhchgx266","ex_address") .
sh_resultSeverity("node1hgobhchgx266","sh_Violation") .
sh_sourceConstraintComponent("node1hgobhchgx266","sh_OrConstraintComponent") .
sh_sourceShape("node1hgobhchgx266","ex_AddressShape_address") .
sh_value("node1hgobhchgx266","true") .
