...
mf_entries("http://repairs.shacl.org","node1hgobhchgx37") .
rdf_first("node1hgobhchgx37","http://repairs.shacl.org/hasValue_001") .
rdf_rest("node1hgobhchgx37","rdf_nil") .
...
mf_action("http://repairs.shacl.org/hasValue_001","node1hgobhchgx38") .
sht_dataGraph("node1hgobhchgx38","http://repairs.shacl.org") .
sht_shapesGraph("node1hgobhchgx38","http://repairs.shacl.org") .
mf_result("http://repairs.shacl.org/hasValue_001","node1hgobhchgx39") .
sh_ValidationReport("node1hgobhchgx39") .
sh_conforms("node1hgobhchgx39","false") .
xsd_boolean("false") .
sh_result("node1hgobhchgx39","node1hgobhchgx40") .
sh_ValidationResult("node1hgobhchgx40") .
sh_focusNode("node1hgobhchgx40","ex_InvalidMalePerson") .
sh_resultPath("node1hgobhchgx40","ex_gender") .
sh_resultSeverity("node1hgobhchgx40","sh_Violation") .
sh_sourceConstraintComponent("node1hgobhchgx40","sh_HasValueConstraintComponent") .
sh_sourceShape("node1hgobhchgx40","ex_PersonShape_gender") .
