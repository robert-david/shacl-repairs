...
node1hgobfebhx6_(X,"f"):-s0_(X,"t*") .
node1hgobfebhx6_(X,"t*"):-s0_(X,"f") .
node1hgobfebhx4_(X,"t*"):-node1hgobfebhx6_(X,"t*") .
node1hgobfebhx4_(X,"f"):-node1hgobfebhx6_(X,"f") .

% sh:minCount 1 for node1hgobfebhx4
s1_(X,"t*"):-node1hgobfebhx4_(X,"t*") .
...
_enrolledIn_(X,Y,"f"):-s1_(X,"f"),_enrolledIn_(X,Y,"t*"),_enrolledIn_(X,Y,"f") .
1 {s2_(Y,"t*"):_enrolledIn_(X,Y,"t**")} 1:-s1_(X,"t*") .

_course_(X,"t"):-s2_(X,"t*") .
_course_(X,"f"):-s2_(X,"f") .

% universal for node1hgobfebhx4
s3_(X,"t*"):-node1hgobfebhx4_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
_enrolledIn_(X,Y,"f"):-s4_(X,"f"),_enrolledIn_(X,Y,"t*"),_enrolledIn_(X,Y,"f") .
...
s1_(X,"f");s3_(X,"f"):-node1hgobfebhx4_(X,"f") .
s7_(X,"t*"):-_teacher_(X,"t*") .
node1hgobfebhx5_(X,"t*"):-s7_(X,"t*") .
node1hgobfebhx5_(X,"f"):-s7_(X,"f") .

% sh:minCount 1 for node1hgobfebhx5
s8_(X,"t*"):-node1hgobfebhx5_(X,"t*") .
_teaches_(X,@new(s8,X,_teaches,1..1),"t"):-choose(s8,X,_teaches,1) .
choose(s8,X,_teaches,1);choose(s8,X,_teaches,0):-s8_(X,"t*") .
(C-0) {_teaches_(X,Y,"f"):_teaches_(X,Y,"t*");s9_(Y,"f"):_teaches_(X,Y,"t*"),not _teaches_(X,Y,"f")} (C-0):-s8_(X,"f"),#count {Y:_teaches_(X,Y,"t*")}=C,C>0 .
_teaches_(X,Y,"f"):-s8_(X,"f"),_teaches_(X,Y,"t*"),_teaches_(X,Y,"f") .
1 {s9_(Y,"t*"):_teaches_(X,Y,"t**")} 1:-s8_(X,"t*") .


% universal for node1hgobfebhx5
s10_(X,"t*"):-node1hgobfebhx5_(X,"t*") .
s11_(X,"f"):-s10_(X,"t*") .
s11_(X,"t*"):-s10_(X,"f") .
_teaches_(X,@new(s11,X,_teaches,1..1),"t"):-choose(s11,X,_teaches,1) .
choose(s11,X,_teaches,1);choose(s11,X,_teaches,0):-s11_(X,"t*") .
(C-0) {_teaches_(X,Y,"f"):_teaches_(X,Y,"t*");s12_(Y,"f"):_teaches_(X,Y,"t*"),not _teaches_(X,Y,"f")} (C-0):-s11_(X,"f"),#count {Y:_teaches_(X,Y,"t*")}=C,C>0 .
_teaches_(X,Y,"f"):-s11_(X,"f"),_teaches_(X,Y,"t*"),_teaches_(X,Y,"f") .
1 {s12_(Y,"t*"):_teaches_(X,Y,"t**")} 1:-s11_(X,"t*") .
s13_(X,"f"):-s12_(X,"t*") .
s13_(X,"t*"):-s12_(X,"f") .


s8_(X,"f");s10_(X,"f"):-node1hgobfebhx5_(X,"f") .
s0_(X,"f");s7_(X,"f"):-_teacher_(X,"f") .
s14_(X,"t*"):-_student_(X,"t*") .
node1hgobfebhx4_(X,"t*"):-s14_(X,"t*") .
node1hgobfebhx4_(X,"f"):-s14_(X,"f") .

s15_(X,"t*"):-node1hgobfebhx4_(X,"t*") .
...
s15_(X,"f");s17_(X,"f"):-node1hgobfebhx4_(X,"f") .
s21_(X,"t*"):-_student_(X,"t*") .
node1hgobfebhx4_(X,"t*"):-s21_(X,"t*") .
node1hgobfebhx4_(X,"f"):-s21_(X,"f") .

% sh:minCount 0 for node1hgobfebhx4
s22_(X,"t*"):-node1hgobfebhx4_(X,"t*") .
...
s22_(X,"f");s24_(X,"f"):-node1hgobfebhx4_(X,"f") .
