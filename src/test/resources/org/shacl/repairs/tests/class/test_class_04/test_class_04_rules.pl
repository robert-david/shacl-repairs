...
bnode_dea9ccf2d757419c8e830b6f6b5b179517_st_(X,Y,"t*"):-bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,_),d_worksFor_(X,Y,"t*") .
...
bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"t*"):-s0_(X,"t*") .
bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"f"):-s0_(X,"f") .

% sh:minCount 0 for bnode_dea9ccf2d757419c8e830b6f6b5b179517
s1_(X,"t*"):-bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"t*") .
...
bnode_dea9ccf2d757419c8e830b6f6b5b179518_(X,"f"):-s2_(X,"t*") .
bnode_dea9ccf2d757419c8e830b6f6b5b179518_(X,"t*"):-s2_(X,"f") .
d_Organization_(X,"t"):-bnode_dea9ccf2d757419c8e830b6f6b5b179518_(X,"t*") .
d_Organization_(X,"f"):-bnode_dea9ccf2d757419c8e830b6f6b5b179518_(X,"f") .

% universal for bnode_dea9ccf2d757419c8e830b6f6b5b179517
s3_(X,"t*"):-bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
bnode_dea9ccf2d757419c8e830b6f6b5b179518_(X,"f"):-s6_(X,"t*") .
bnode_dea9ccf2d757419c8e830b6f6b5b179518_(X,"t*"):-s6_(X,"f") .

s1_(X,"f");s3_(X,"f"):-bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"f") .
s7_(X,"t*"):-d_PersonShape_(X,"t*") .
bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"t*"):-s7_(X,"t*") .
bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"f"):-s7_(X,"f") .

% sh:minCount 2 for bnode_dea9ccf2d757419c8e830b6f6b5b179517
s8_(X,"t*"):-bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"t*") .
d_worksFor_(X,@new(s8,X,d_worksFor,1..1),"t"):-choose(s8,X,d_worksFor,1) .
d_worksFor_(X,@new(s8,X,d_worksFor,1..2),"t"):-choose(s8,X,d_worksFor,2) .
choose(s8,X,d_worksFor,2);choose(s8,X,d_worksFor,1);choose(s8,X,d_worksFor,0):-s8_(X,"t*") .
(C-1) {d_worksFor_(X,Y,"f"):d_worksFor_(X,Y,"t*");s9_(Y,"f"):d_worksFor_(X,Y,"t*"),not d_worksFor_(X,Y,"f")} (C-1):-s8_(X,"f"),#count {Y:d_worksFor_(X,Y,"t*")}=C,C>1 .
2 {s9_(Y,"t*"):d_worksFor_(X,Y,"t**")} 2:-s8_(X,"t*") .


s10_(X,"t*"):-bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"t*") .
s11_(X,"f"):-s10_(X,"t*") .
s11_(X,"t*"):-s10_(X,"f") .
...
s8_(X,"f");s10_(X,"f"):-bnode_dea9ccf2d757419c8e830b6f6b5b179517_(X,"f") .
s0_(X,"f");s7_(X,"f"):-d_PersonShape_(X,"f") .

% Interpretation Rules

d_worksFor_(X,Y,"t**"):-d_worksFor_(X,Y,"t*"),not d_worksFor_(X,Y,"f") .
bnode_dea9ccf2d757419c8e830b6f6b5b179517_st_(X,Y,"t**"):-d_worksFor_(X,Y,"t**"),bnode_dea9ccf2d757419c8e830b6f6b5b179517_st_(X,Y,"t*"),not bnode_dea9ccf2d757419c8e830b6f6b5b179517_st_(X,Y,"f") .
