...
node1g838e3u1x20_(X,"t*"):-_personShape_(X,"t*") .

% sh:minCount 2 for node1g838e3u1x20
s0_(X,"t*"):-node1g838e3u1x20_(X,"t*") .
...
% universal for node1g838e3u1x20
s2_(X,"t*"):-node1g838e3u1x20_(X,"t*") .
s3_(X,"f"):-s2_(X,"t*") .
s3_(X,"t*"):-s2_(X,"f") .
...
s0_(X,"f");s2_(X,"f"):-node1g838e3u1x20_(X,"f") .
node1g838e3u1x20_(X,"f"):-_personShape_(X,"f") .
