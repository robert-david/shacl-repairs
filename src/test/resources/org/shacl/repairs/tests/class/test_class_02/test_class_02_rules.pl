...
node1hdcdgs0ox778_(X,"f"):-_personShape_(X,"t*") .
node1hdcdgs0ox778_(X,"t*"):-_personShape_(X,"f") .
_person_(X,"t"):-node1hdcdgs0ox778_(X,"t*") .
_person_(X,"f"):-node1hdcdgs0ox778_(X,"f") .
