...
node1g838e3u1x61_(X,"t*"):-_personShape_(X,"t*") .

% sh:minCount 2 for node1g838e3u1x61
s0_(X,"t*"):-node1g838e3u1x61_(X,"t*") .
...
% universal for node1g838e3u1x61
s4_(X,"t*"):-node1g838e3u1x61_(X,"t*") .
s5_(X,"f"):-s4_(X,"t*") .
s5_(X,"t*"):-s4_(X,"f") .
...
s0_(X,"f");s4_(X,"f"):-node1g838e3u1x61_(X,"f") .
node1g838e3u1x61_(X,"f"):-_personShape_(X,"f") .
