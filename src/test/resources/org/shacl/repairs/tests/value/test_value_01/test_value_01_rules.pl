...
node1hmcj2vjcx2_st_(X,Y,"t*"):-node1hmcj2vjcx2_(X,_),_name_(X,Y,"t*") .

% Repair Rules

s0_(X,"t*"):-_personShape_(X,"t*") .
node1hmcj2vjcx2_(X,"t*"):-s0_(X,"t*") .
node1hmcj2vjcx2_(X,"f"):-s0_(X,"f") .

% sh:minCount 3 for node1hmcj2vjcx2
s1_(X,"t*"):-node1hmcj2vjcx2_(X,"t*") .
...
% universal for node1hmcj2vjcx2
s3_(X,"t*"):-node1hmcj2vjcx2_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s1_(X,"f");s3_(X,"f"):-node1hmcj2vjcx2_(X,"f") .
s7_(X,"t*"):-_personShape_(X,"t*") .
node1hmcj2vjcx2_(X,"t*"):-s7_(X,"t*") .
node1hmcj2vjcx2_(X,"f"):-s7_(X,"f") .

s8_(X,"t*"):-node1hmcj2vjcx2_(X,"t*") .
...
% sh:minCount 0 for node1hmcj2vjcx2
s10_(X,"t*"):-node1hmcj2vjcx2_(X,"t*") .
...
s8_(X,"f");s10_(X,"f");s12_(X,"f"):-node1hmcj2vjcx2_(X,"f") .
s0_(X,"f");s7_(X,"f"):-_personShape_(X,"f") .

% Interpretation Rules

_name_(X,Y,"t**"):-_name_(X,Y,"t*"),not _name_(X,Y,"f") .
node1hmcj2vjcx2_st_(X,Y,"t**"):-_name_(X,Y,"t**"),node1hmcj2vjcx2_st_(X,Y,"t*"),not node1hmcj2vjcx2_st_(X,Y,"f") .
