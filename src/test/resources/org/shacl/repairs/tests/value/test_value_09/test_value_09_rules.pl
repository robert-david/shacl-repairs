...
bnode_3436295670d5441a8691a5d61f971bee53_st_(X,Y,"t*"):-bnode_3436295670d5441a8691a5d61f971bee53_(X,_),d_name_(X,Y,"t*") .

% Repair Rules

s0_(X,"t*"):-d_PersonShape_(X,"t*") .
bnode_3436295670d5441a8691a5d61f971bee53_(X,"t*"):-s0_(X,"t*") .
bnode_3436295670d5441a8691a5d61f971bee53_(X,"f"):-s0_(X,"f") .

% sh:minCount 0 for bnode_3436295670d5441a8691a5d61f971bee53
s1_(X,"t*"):-bnode_3436295670d5441a8691a5d61f971bee53_(X,"t*") .
...
% universal for bnode_3436295670d5441a8691a5d61f971bee53
s5_(X,"t*"):-bnode_3436295670d5441a8691a5d61f971bee53_(X,"t*") .
s6_(X,"f"):-s5_(X,"t*") .
s6_(X,"t*"):-s5_(X,"f") .
...
s1_(X,"f");s5_(X,"f"):-bnode_3436295670d5441a8691a5d61f971bee53_(X,"f") .
s11_(X,"t*"):-d_PersonShape_(X,"t*") .
bnode_3436295670d5441a8691a5d61f971bee53_(X,"t*"):-s11_(X,"t*") .
bnode_3436295670d5441a8691a5d61f971bee53_(X,"f"):-s11_(X,"f") .

% sh:minCount 1 for bnode_3436295670d5441a8691a5d61f971bee53
s12_(X,"t*"):-bnode_3436295670d5441a8691a5d61f971bee53_(X,"t*") .
d_name_(X,@new(s12,X,d_name,1..1),"t"):-choose(s12,X,d_name,1) .
choose(s12,X,d_name,1);choose(s12,X,d_name,0):-s12_(X,"t*") .
0 {d_name_(X,Y,"t"):const(Y)} 2:-s12_(X,"t*") .
(C-0) {d_name_(X,Y,"f"):d_name_(X,Y,"t*");s13_(Y,"f"):d_name_(X,Y,"t*"),not d_name_(X,Y,"f")} (C-0):-s12_(X,"f"),#count {Y:d_name_(X,Y,"t*")}=C,C>0 .
1 {s13_(Y,"t*"):d_name_(X,Y,"t**")} 2:-s12_(X,"t*") .


s14_(X,"t*"):-bnode_3436295670d5441a8691a5d61f971bee53_(X,"t*") .
s15_(X,"f"):-s14_(X,"t*") .
s15_(X,"t*"):-s14_(X,"f") .
...
s12_(X,"f");s14_(X,"f"):-bnode_3436295670d5441a8691a5d61f971bee53_(X,"f") .
s0_(X,"f");s11_(X,"f"):-d_PersonShape_(X,"f") .

% Interpretation Rules

d_name_(X,Y,"t**"):-d_name_(X,Y,"t*"),not d_name_(X,Y,"f") .
bnode_3436295670d5441a8691a5d61f971bee53_st_(X,Y,"t**"):-d_name_(X,Y,"t**"),bnode_3436295670d5441a8691a5d61f971bee53_st_(X,Y,"t*"),not bnode_3436295670d5441a8691a5d61f971bee53_st_(X,Y,"f") .
