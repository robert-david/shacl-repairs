...
node1g832fjsax170_(X,"t*"):-_personShape_(X,"t*") .

% sh:minCount 2 for node1g832fjsax170
s0_(X,"t*"):-node1g832fjsax170_(X,"t*") .
_name_(X,@new(s0,X,_name,1..1),"t"):-choose(s0,X,_name,1) .
_name_(X,@new(s0,X,_name,1..2),"t"):-choose(s0,X,_name,2) .
choose(s0,X,_name,2);choose(s0,X,_name,1);choose(s0,X,_name,0):-s0_(X,"t*") .
(C-1) {_name_(X,Y,"f"):_name(X,Y);s1_(Y,"f"):_name_(X,Y,"t*"),not _name_(X,Y,"f")} (C-1):-s0_(X,"f"),#count {Y:_name_(X,Y,"t*")}=C,C>1 .
0 {_name_(X,Y,"t"):const(Y)} 1:-s0_(X,"t*") .
2 {s1_(Y,"t*"):_name_(X,Y,"t**")} 2:-s0_(X,"t*") .

s2_(X,"f"):-s1_(X,"f") .
node1g832fjsax173_(X,"f"):-s2_(X,"t*") .
node1g832fjsax173_(X,"t*"):-s2_(X,"f") .
s3_(X,"f"):-s1_(X,"f") .
node1g832fjsax176_(X,"f"):-s3_(X,"t*") .
node1g832fjsax176_(X,"t*"):-s3_(X,"f") .
_person_(X,"t"):-node1g832fjsax176_(X,"t*") .
_person_(X,"f"):-node1g832fjsax176_(X,"f") .
s2_(X,"t*");s3_(X,"t*"):-s1_(X,"t*") .

% universal for node1g832fjsax170
s4_(X,"t*"):-node1g832fjsax170_(X,"t*") .
s5_(X,"f"):-s4_(X,"t*") .
s5_(X,"t*"):-s4_(X,"f") .
...
s8_(X,"f"):-s7_(X,"f") .
node1g832fjsax173_(X,"f"):-s8_(X,"t*") .
node1g832fjsax173_(X,"t*"):-s8_(X,"f") .
s9_(X,"f"):-s7_(X,"f") .
node1g832fjsax176_(X,"f"):-s9_(X,"t*") .
node1g832fjsax176_(X,"t*"):-s9_(X,"f") .
s8_(X,"t*");s9_(X,"t*"):-s7_(X,"t*") .

s0_(X,"f");s4_(X,"f"):-node1g832fjsax170_(X,"f") .
node1g832fjsax170_(X,"f"):-_personShape_(X,"f") .
...
:-node1g832fjsax173_(X,"t*"),X!="ANN" .
:-node1g832fjsax173_(X,"f"),X="ANN" .
