...
node1g832fjsax39_(X,"t*"):-_personShape_(X,"t*") .
s0_(X,"t*"):-node1g832fjsax39_(X,"t*") .
...
% sh:minCount 2 for node1g832fjsax39
s2_(X,"t*"):-node1g832fjsax39_(X,"t*") .
_name_(X,@new(s2,X,_name,1..1),"t"):-choose(s2,X,_name,1) .
_name_(X,@new(s2,X,_name,1..2),"t"):-choose(s2,X,_name,2) .
choose(s2,X,_name,2);choose(s2,X,_name,1);choose(s2,X,_name,0):-s2_(X,"t*") .
(C-1) {_name_(X,Y,"f"):_name(X,Y);s3_(Y,"f"):_name_(X,Y,"t*"),not _name_(X,Y,"f")} (C-1):-s2_(X,"f"),#count {Y:_name_(X,Y,"t*")}=C,C>1 .
0 {_name_(X,Y,"t"):const(Y)} 2:-s2_(X,"t*") .
2 {s3_(Y,"t*"):_name_(X,Y,"t**")} 2:-s2_(X,"t*") .

node1g832fjsax40_(X,"f"):-s3_(X,"t*") .
node1g832fjsax40_(X,"t*"):-s3_(X,"f") .

% universal for node1g832fjsax39
s4_(X,"t*"):-node1g832fjsax39_(X,"t*") .
s5_(X,"f"):-s4_(X,"t*") .
s5_(X,"t*"):-s4_(X,"f") .
...
node1g832fjsax40_(X,"f"):-s7_(X,"t*") .
node1g832fjsax40_(X,"t*"):-s7_(X,"f") .

s0_(X,"f");s2_(X,"f");s4_(X,"f"):-node1g832fjsax39_(X,"f") .
node1g832fjsax39_(X,"f"):-_personShape_(X,"f") .
...
:-node1g832fjsax40_(X,"t*"),X!="ANN" .
:-node1g832fjsax40_(X,"f"),X="ANN" .
