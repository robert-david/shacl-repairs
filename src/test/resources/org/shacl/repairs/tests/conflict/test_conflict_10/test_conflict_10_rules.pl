...
node1hgobfebhx1862_(X,"f"):-_notPersonShape_(X,"t*") .
node1hgobfebhx1862_(X,"t*"):-_notPersonShape_(X,"f") .
s0_(X,"t*"):-node1hgobfebhx1862_(X,"t*") .
_person_(X,"t"):-s0_(X,"t*") .
_person_(X,"f"):-s0_(X,"f") .
s1_(X,"t*"):-node1hgobfebhx1862_(X,"t*") .
node1hgobfebhx1861_(X,"f"):-s1_(X,"t*") .
node1hgobfebhx1861_(X,"t*"):-s1_(X,"f") .
_organization_(X,"t"):-node1hgobfebhx1861_(X,"t*") .
_organization_(X,"f"):-node1hgobfebhx1861_(X,"f") .
s0_(X,"f");s1_(X,"f"):-node1hgobfebhx1862_(X,"f") .
s2_(X,"t*"):-_personShape_(X,"t*") .
_person_(X,"t"):-s2_(X,"t*") .
_person_(X,"f"):-s2_(X,"f") .
s3_(X,"t*"):-_personShape_(X,"t*") .
node1hgobfebhx1861_(X,"f"):-s3_(X,"t*") .
node1hgobfebhx1861_(X,"t*"):-s3_(X,"f") .
