...
node1hdcdgs0ox646_(X,"f"):-_notPersonShape_(X,"t*") .
node1hdcdgs0ox646_(X,"t*"):-_notPersonShape_(X,"f") .
_person_(X,"t"):-node1hdcdgs0ox646_(X,"t*") .
_person_(X,"f"):-node1hdcdgs0ox646_(X,"f") .
