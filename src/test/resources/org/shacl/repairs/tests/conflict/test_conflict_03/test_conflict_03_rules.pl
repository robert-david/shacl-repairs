...
node1hmci94m4x24_(X,"f"):-_notPersonShape_(X,"t*") .
node1hmci94m4x24_(X,"t*"):-_notPersonShape_(X,"f") .
_person_(X,"t"):-node1hmci94m4x24_(X,"t*") .
_person_(X,"f"):-node1hmci94m4x24_(X,"f") .
