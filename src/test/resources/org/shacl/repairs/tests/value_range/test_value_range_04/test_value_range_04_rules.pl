...
bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_st_(X,Y,"t*"):-bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_(X,_),d_hasValue_(X,Y,"t*") .

% Repair Rules

bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_(X,"t*"):-d_OutlierShape_(X,"t*") .
bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_(X,"f"):-d_OutlierShape_(X,"f") .

s0_(X,"t*"):-bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_(X,"t*") .
d_hasValue_(X,Y,"f"):-s0_(X,"t*"),d_hasValue_(X,Y,"t*"),@lt(Y,"2")="f" .
d_hasValue_(X,Y,"f"):-s0_(X,"f"),d_hasValue_(X,Y,"t*"),@lt(Y,"2")="t" .

% sh:minCount 0 for bnode_7f9d9b63cd6e4fd98d80676ce404d35f19
s1_(X,"t*"):-bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_(X,"t*") .
...
% universal for bnode_7f9d9b63cd6e4fd98d80676ce404d35f19
s3_(X,"t*"):-bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s0_(X,"f");s1_(X,"f");s3_(X,"f"):-bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_(X,"f") .

% Interpretation Rules

d_hasValue_(X,Y,"t**"):-d_hasValue_(X,Y,"t*"),not d_hasValue_(X,Y,"f") .
bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_st_(X,Y,"t**"):-d_hasValue_(X,Y,"t**"),bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_st_(X,Y,"t*"),not bnode_7f9d9b63cd6e4fd98d80676ce404d35f19_st_(X,Y,"f") .
