...
bnode_bb0cf4d496474c7ba4585a519faa989c16_st_(X,Y,"t*"):-bnode_bb0cf4d496474c7ba4585a519faa989c16_(X,_),d_hasValue_(X,Y,"t*") .

% Repair Rules

bnode_bb0cf4d496474c7ba4585a519faa989c16_(X,"t*"):-d_OutlierShape_(X,"t*") .
bnode_bb0cf4d496474c7ba4585a519faa989c16_(X,"f"):-d_OutlierShape_(X,"f") .

% sh:minCount 0 for bnode_bb0cf4d496474c7ba4585a519faa989c16
s0_(X,"t*"):-bnode_bb0cf4d496474c7ba4585a519faa989c16_(X,"t*") .
...
s2_(X,"t*"):-bnode_bb0cf4d496474c7ba4585a519faa989c16_(X,"t*") .
d_hasValue_(X,Y,"f"):-s2_(X,"t*"),d_hasValue_(X,Y,"t*"),@gt(Y,"2")="f" .
d_hasValue_(X,Y,"f"):-s2_(X,"f"),d_hasValue_(X,Y,"t*"),@gt(Y,"2")="t" .

% universal for bnode_bb0cf4d496474c7ba4585a519faa989c16
s3_(X,"t*"):-bnode_bb0cf4d496474c7ba4585a519faa989c16_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s0_(X,"f");s2_(X,"f");s3_(X,"f"):-bnode_bb0cf4d496474c7ba4585a519faa989c16_(X,"f") .

% Interpretation Rules

d_hasValue_(X,Y,"t**"):-d_hasValue_(X,Y,"t*"),not d_hasValue_(X,Y,"f") .
bnode_bb0cf4d496474c7ba4585a519faa989c16_st_(X,Y,"t**"):-d_hasValue_(X,Y,"t**"),bnode_bb0cf4d496474c7ba4585a519faa989c16_st_(X,Y,"t*"),not bnode_bb0cf4d496474c7ba4585a519faa989c16_st_(X,Y,"f") .
