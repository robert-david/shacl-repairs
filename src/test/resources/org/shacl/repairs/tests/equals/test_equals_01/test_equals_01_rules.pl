...
bnode_169a36fbc2404db285bbeb40e7a6c7c72_st_(X,Y,"t*"):-bnode_169a36fbc2404db285bbeb40e7a6c7c72_(X,_),_enrolledIn_(X,Y,"t*") .
_hasCourse_(X,Y,"t*"):-_hasCourse(X,Y) .
_hasCourse_(X,Y,"t*"):-_hasCourse_(X,Y,"t") .

% Repair Rules

bnode_169a36fbc2404db285bbeb40e7a6c7c72_(X,"t*"):-_studentShape_(X,"t*") .
bnode_169a36fbc2404db285bbeb40e7a6c7c72_(X,"f"):-_studentShape_(X,"f") .

% sh:minCount 0 for bnode_169a36fbc2404db285bbeb40e7a6c7c72
s0_(X,"t*"):-bnode_169a36fbc2404db285bbeb40e7a6c7c72_(X,"t*") .
...
0 {s1_(Y,"t*"):_enrolledIn_(X,Y,"t**")} 0:-s0_(X,"t*") .


s2_(X,"t*"):-bnode_169a36fbc2404db285bbeb40e7a6c7c72_(X,"t*") .
...
% universal for bnode_169a36fbc2404db285bbeb40e7a6c7c72
s3_(X,"t*"):-bnode_169a36fbc2404db285bbeb40e7a6c7c72_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s0_(X,"f");s2_(X,"f");s3_(X,"f"):-bnode_169a36fbc2404db285bbeb40e7a6c7c72_(X,"f") .

% Interpretation Rules

_enrolledIn_(X,Y,"t**"):-_enrolledIn_(X,Y,"t*"),not _enrolledIn_(X,Y,"f") .
bnode_169a36fbc2404db285bbeb40e7a6c7c72_st_(X,Y,"t**"):-_enrolledIn_(X,Y,"t**"),bnode_169a36fbc2404db285bbeb40e7a6c7c72_st_(X,Y,"t*"),not bnode_169a36fbc2404db285bbeb40e7a6c7c72_st_(X,Y,"f") .
