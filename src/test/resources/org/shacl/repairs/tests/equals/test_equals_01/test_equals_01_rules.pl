...
bnode_68844fcfc9fd4e0fb69b18139988a87b2_st_(X,Y,"t*"):-bnode_68844fcfc9fd4e0fb69b18139988a87b2_(X,_),d_enrolledIn_(X,Y,"t*") .
d_hasCourse_(X,Y,"t*"):-d_hasCourse(X,Y) .
d_hasCourse_(X,Y,"t*"):-d_hasCourse_(X,Y,"t") .

% Repair Rules

bnode_68844fcfc9fd4e0fb69b18139988a87b2_(X,"t*"):-d_StudentShape_(X,"t*") .
bnode_68844fcfc9fd4e0fb69b18139988a87b2_(X,"f"):-d_StudentShape_(X,"f") .

% sh:minCount 0 for bnode_68844fcfc9fd4e0fb69b18139988a87b2
s0_(X,"t*"):-bnode_68844fcfc9fd4e0fb69b18139988a87b2_(X,"t*") .
...
0 {s1_(Y,"t*"):d_enrolledIn_(X,Y,"t**")} 0:-s0_(X,"t*") .


s2_(X,"t*"):-bnode_68844fcfc9fd4e0fb69b18139988a87b2_(X,"t*") .
...
% universal for bnode_68844fcfc9fd4e0fb69b18139988a87b2
s3_(X,"t*"):-bnode_68844fcfc9fd4e0fb69b18139988a87b2_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s0_(X,"f");s2_(X,"f");s3_(X,"f"):-bnode_68844fcfc9fd4e0fb69b18139988a87b2_(X,"f") .

% Interpretation Rules

d_enrolledIn_(X,Y,"t**"):-d_enrolledIn_(X,Y,"t*"),not d_enrolledIn_(X,Y,"f") .
bnode_68844fcfc9fd4e0fb69b18139988a87b2_st_(X,Y,"t**"):-d_enrolledIn_(X,Y,"t**"),bnode_68844fcfc9fd4e0fb69b18139988a87b2_st_(X,Y,"t*"),not bnode_68844fcfc9fd4e0fb69b18139988a87b2_st_(X,Y,"f") .
