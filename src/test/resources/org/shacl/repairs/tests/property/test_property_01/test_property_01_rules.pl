...
bnode_2fd914312f0649d499c395963ae8b2a510_st_(X,Y,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a510_(X,_),d_worksFor_(X,Y,"t*") .
bnode_2fd914312f0649d499c395963ae8b2a514_st_(X,Y,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a514_(X,_),d_worksFor_(X,Y,"t*") .

% Repair Rules

s0_(X,"f"):-d_PersonShape_(X,"f") .
bnode_2fd914312f0649d499c395963ae8b2a510_(X,"t*"):-s0_(X,"t*") .
bnode_2fd914312f0649d499c395963ae8b2a510_(X,"f"):-s0_(X,"f") .

% sh:minCount 1 for bnode_2fd914312f0649d499c395963ae8b2a510
s1_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a510_(X,"t*") .
...
% universal for bnode_2fd914312f0649d499c395963ae8b2a510
s3_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a510_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s1_(X,"f");s3_(X,"f"):-bnode_2fd914312f0649d499c395963ae8b2a510_(X,"f") .
s7_(X,"f"):-d_PersonShape_(X,"f") .
bnode_2fd914312f0649d499c395963ae8b2a513_(X,"f"):-s7_(X,"t*") .
bnode_2fd914312f0649d499c395963ae8b2a513_(X,"t*"):-s7_(X,"f") .
bnode_2fd914312f0649d499c395963ae8b2a514_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a513_(X,"t*") .
bnode_2fd914312f0649d499c395963ae8b2a514_(X,"f"):-bnode_2fd914312f0649d499c395963ae8b2a513_(X,"f") .

% sh:minCount 1 for bnode_2fd914312f0649d499c395963ae8b2a514
s8_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a514_(X,"t*") .
...
% universal for bnode_2fd914312f0649d499c395963ae8b2a514
s10_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a514_(X,"t*") .
s11_(X,"f"):-s10_(X,"t*") .
s11_(X,"t*"):-s10_(X,"f") .
...
s8_(X,"f");s10_(X,"f"):-bnode_2fd914312f0649d499c395963ae8b2a514_(X,"f") .
s0_(X,"t*");s7_(X,"t*"):-d_PersonShape_(X,"t*") .

% Interpretation Rules

d_worksFor_(X,Y,"t**"):-d_worksFor_(X,Y,"t*"),not d_worksFor_(X,Y,"f") .
bnode_2fd914312f0649d499c395963ae8b2a510_st_(X,Y,"t**"):-d_worksFor_(X,Y,"t**"),bnode_2fd914312f0649d499c395963ae8b2a510_st_(X,Y,"t*"),not bnode_2fd914312f0649d499c395963ae8b2a510_st_(X,Y,"f") .
bnode_2fd914312f0649d499c395963ae8b2a514_st_(X,Y,"t**"):-d_worksFor_(X,Y,"t**"),bnode_2fd914312f0649d499c395963ae8b2a514_st_(X,Y,"t*"),not bnode_2fd914312f0649d499c395963ae8b2a514_st_(X,Y,"f") .
