...
node1g832o9j6x13_(X,"f"):-s0_(X,"t*") .
node1g832o9j6x13_(X,"t*"):-s0_(X,"f") .
node1g832o9j6x14_(X,"t*"):-node1g832o9j6x13_(X,"t*") .
node1g832o9j6x14_(X,"f"):-node1g832o9j6x13_(X,"f") .

% sh:minCount 1 for node1g832o9j6x14
s1_(X,"t*"):-node1g832o9j6x14_(X,"t*") .
_worksFor_(X,@new(s1,X,_worksFor,1..1),"t"):-choose(s1,X,_worksFor,1) .
choose(s1,X,_worksFor,1);choose(s1,X,_worksFor,0):-s1_(X,"t*") .
(C-0) {_worksFor_(X,Y,"f"):_worksFor(X,Y);s2_(Y,"f"):_worksFor_(X,Y,"t*"),not _worksFor_(X,Y,"f")} (C-0):-s1_(X,"f"),#count {Y:_worksFor_(X,Y,"t*")}=C,C>0 .
1 {s2_(Y,"t*"):_worksFor_(X,Y,"t**")} 1:-s1_(X,"t*") .


% universal for node1g832o9j6x14
s3_(X,"t*"):-node1g832o9j6x14_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
_worksFor_(X,@new(s4,X,_worksFor,1..1),"t"):-choose(s4,X,_worksFor,1) .
choose(s4,X,_worksFor,1);choose(s4,X,_worksFor,0):-s4_(X,"t*") .
(C-0) {_worksFor_(X,Y,"f"):_worksFor(X,Y);s5_(Y,"f"):_worksFor_(X,Y,"t*"),not _worksFor_(X,Y,"f")} (C-0):-s4_(X,"f"),#count {Y:_worksFor_(X,Y,"t*")}=C,C>0 .
1 {s5_(Y,"t*"):_worksFor_(X,Y,"t**")} 1:-s4_(X,"t*") .
s6_(X,"f"):-s5_(X,"t*") .
s6_(X,"t*"):-s5_(X,"f") .


s1_(X,"f");s3_(X,"f"):-node1g832o9j6x14_(X,"f") .
s7_(X,"f"):-_personShape_(X,"f") .
node1g832o9j6x10_(X,"t*"):-s7_(X,"t*") .
node1g832o9j6x10_(X,"f"):-s7_(X,"f") .

% sh:minCount 1 for node1g832o9j6x10
s8_(X,"t*"):-node1g832o9j6x10_(X,"t*") .
_worksFor_(X,@new(s8,X,_worksFor,1..1),"t"):-choose(s8,X,_worksFor,1) .
choose(s8,X,_worksFor,1);choose(s8,X,_worksFor,0):-s8_(X,"t*") .
(C-0) {_worksFor_(X,Y,"f"):_worksFor(X,Y);s9_(Y,"f"):_worksFor_(X,Y,"t*"),not _worksFor_(X,Y,"f")} (C-0):-s8_(X,"f"),#count {Y:_worksFor_(X,Y,"t*")}=C,C>0 .
1 {s9_(Y,"t*"):_worksFor_(X,Y,"t**")} 1:-s8_(X,"t*") .


% universal for node1g832o9j6x10
s10_(X,"t*"):-node1g832o9j6x10_(X,"t*") .
s11_(X,"f"):-s10_(X,"t*") .
s11_(X,"t*"):-s10_(X,"f") .
...
(C-0) {_worksFor_(X,Y,"f"):_worksFor(X,Y);s12_(Y,"f"):_worksFor_(X,Y,"t*"),not _worksFor_(X,Y,"f")} (C-0):-s11_(X,"f"),#count {Y:_worksFor_(X,Y,"t*")}=C,C>0 .
1 {s12_(Y,"t*"):_worksFor_(X,Y,"t**")} 1:-s11_(X,"t*") .
s13_(X,"f"):-s12_(X,"t*") .
s13_(X,"t*"):-s12_(X,"f") .


s8_(X,"f");s10_(X,"f"):-node1g832o9j6x10_(X,"f") .
