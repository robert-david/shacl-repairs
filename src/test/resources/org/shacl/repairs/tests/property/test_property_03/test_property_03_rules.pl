...
bnode_2fd914312f0649d499c395963ae8b2a554_st_(X,Y,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a554_(X,_),d_worksFor_(X,Y,"t*") .
...
bnode_2fd914312f0649d499c395963ae8b2a554_(X,"t*"):-s0_(X,"t*") .
bnode_2fd914312f0649d499c395963ae8b2a554_(X,"f"):-s0_(X,"f") .

% sh:minCount 3 for bnode_2fd914312f0649d499c395963ae8b2a554
s1_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a554_(X,"t*") .
...
d_worksFor_(X,@new(s1,X,d_worksFor,1..3),"t"):-choose(s1,X,d_worksFor,3) .
choose(s1,X,d_worksFor,3);choose(s1,X,d_worksFor,2);choose(s1,X,d_worksFor,1);choose(s1,X,d_worksFor,0):-s1_(X,"t*") .
(C-2) {d_worksFor_(X,Y,"f"):d_worksFor_(X,Y,"t*");s2_(Y,"f"):d_worksFor_(X,Y,"t*"),not d_worksFor_(X,Y,"f")} (C-2):-s1_(X,"f"),#count {Y:d_worksFor_(X,Y,"t*")}=C,C>2 .
d_worksFor_(X,Y,"f"):-d_worksFor_(X,Y,"t*"),d_worksFor_(X,Y,"f") .
3 {s2_(Y,"t*"):d_worksFor_(X,Y,"t**")} 3:-s1_(X,"t*") .


% universal for bnode_2fd914312f0649d499c395963ae8b2a554
s3_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a554_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s1_(X,"f");s3_(X,"f"):-bnode_2fd914312f0649d499c395963ae8b2a554_(X,"f") .
s7_(X,"t*"):-d_PersonShape_(X,"t*") .
bnode_2fd914312f0649d499c395963ae8b2a554_(X,"t*"):-s7_(X,"t*") .
bnode_2fd914312f0649d499c395963ae8b2a554_(X,"f"):-s7_(X,"f") .

% sh:minCount 0 for bnode_2fd914312f0649d499c395963ae8b2a554
s8_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a554_(X,"t*") .
...
s10_(X,"t*"):-bnode_2fd914312f0649d499c395963ae8b2a554_(X,"t*") .
s11_(X,"f"):-s10_(X,"t*") .
s11_(X,"t*"):-s10_(X,"f") .
...
s8_(X,"f");s10_(X,"f"):-bnode_2fd914312f0649d499c395963ae8b2a554_(X,"f") .
s0_(X,"f");s7_(X,"f"):-d_PersonShape_(X,"f") .

% Interpretation Rules

d_worksFor_(X,Y,"t**"):-d_worksFor_(X,Y,"t*"),not d_worksFor_(X,Y,"f") .
bnode_2fd914312f0649d499c395963ae8b2a554_st_(X,Y,"t**"):-d_worksFor_(X,Y,"t**"),bnode_2fd914312f0649d499c395963ae8b2a554_st_(X,Y,"t*"),not bnode_2fd914312f0649d499c395963ae8b2a554_st_(X,Y,"f") .
