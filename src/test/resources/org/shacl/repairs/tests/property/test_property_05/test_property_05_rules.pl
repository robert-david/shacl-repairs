...
node1g832o9j6x65_(X,"f"):-_personShapeB_(X,"t*") .
node1g832o9j6x65_(X,"t*"):-_personShapeB_(X,"f") .
node1g832o9j6x66_(X,"t*"):-node1g832o9j6x65_(X,"t*") .
node1g832o9j6x66_(X,"f"):-node1g832o9j6x65_(X,"f") .

% sh:minCount 3 for node1g832o9j6x66
s0_(X,"t*"):-node1g832o9j6x66_(X,"t*") .
...
(C-2) {_worksFor_(X,Y,"f"):_worksFor(X,Y);s1_(Y,"f"):_worksFor_(X,Y,"t*"),not _worksFor_(X,Y,"f")} (C-2):-s0_(X,"f"),#count {Y:_worksFor_(X,Y,"t*")}=C,C>2 .
3 {s1_(Y,"t*"):_worksFor_(X,Y,"t**")} 3:-s0_(X,"t*") .

_organization_(X,"t"):-s1_(X,"t*") .
_organization_(X,"f"):-s1_(X,"f") .

% universal for node1g832o9j6x66
s2_(X,"t*"):-node1g832o9j6x66_(X,"t*") .
s3_(X,"f"):-s2_(X,"t*") .
s3_(X,"t*"):-s2_(X,"f") .
...
s0_(X,"f");s2_(X,"f"):-node1g832o9j6x66_(X,"f") .
node1g832o9j6x64_(X,"t*"):-_personShapeA_(X,"t*") .

% sh:minCount 2 for node1g832o9j6x64
s6_(X,"t*"):-node1g832o9j6x64_(X,"t*") .
...
% universal for node1g832o9j6x64
s8_(X,"t*"):-node1g832o9j6x64_(X,"t*") .
s9_(X,"f"):-s8_(X,"t*") .
s9_(X,"t*"):-s8_(X,"f") .
...
s6_(X,"f");s8_(X,"f"):-node1g832o9j6x64_(X,"f") .
node1g832o9j6x64_(X,"f"):-_personShapeA_(X,"f") .
