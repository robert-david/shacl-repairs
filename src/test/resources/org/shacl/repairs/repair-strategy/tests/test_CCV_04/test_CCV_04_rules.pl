...
node1hgvtqvi9x137_(X,"t*"):-s0_(X,"t*") .
node1hgvtqvi9x137_(X,"f"):-s0_(X,"f") .

% sh:minCount 1 for node1hgvtqvi9x137
s1_(X,"t*"):-node1hgvtqvi9x137_(X,"t*") .
...
% universal for node1hgvtqvi9x137
s3_(X,"t*"):-node1hgvtqvi9x137_(X,"t*") .
s4_(X,"f"):-s3_(X,"t*") .
s4_(X,"t*"):-s3_(X,"f") .
...
s1_(X,"f");s3_(X,"f"):-node1hgvtqvi9x137_(X,"f") .
s7_(X,"t*"):-_obligationStateShape_(X,"t*") .
node1hgvtqvi9x137_(X,"t*"):-s7_(X,"t*") .
node1hgvtqvi9x137_(X,"f"):-s7_(X,"f") .

% sh:minCount 0 for node1hgvtqvi9x137
s8_(X,"t*"):-node1hgvtqvi9x137_(X,"t*") .
choose(s8,X,_hasState,0):-s8_(X,"t*") .
0 {_hasState_(X,Y,"t"):const(Y)} 3:-s8_(X,"t*") .
(C-0) {_hasState_(X,Y,"f"):_hasState_(X,Y,"t*");s9_(Y,"f"):_hasState_(X,Y,"t*"),not _hasState_(X,Y,"f")} (C-0):-s8_(X,"f"),#count {Y:_hasState_(X,Y,"t*")}=C,C>0 .
_hasState_(X,Y,"f"):-s8_(X,"f"),_hasState_(X,Y,"t*"),_hasState_(X,Y,"f") .
0 {s9_(Y,"t*"):_hasState_(X,Y,"t**")} 3:-s8_(X,"t*") .


% sh:maxCount 1 for node1hgvtqvi9x137
s10_(X,"t*"):-node1hgvtqvi9x137_(X,"t*") .
s11_(X,"f"):-s10_(X,"t*") .
s11_(X,"t*"):-s10_(X,"f") .
_hasState_(X,@new(s11,X,_hasState,1..1),"t"):-choose(s11,X,_hasState,1) .
_hasState_(X,@new(s11,X,_hasState,1..2),"t"):-choose(s11,X,_hasState,2) .
choose(s11,X,_hasState,2);choose(s11,X,_hasState,1);choose(s11,X,_hasState,0):-s11_(X,"t*") .
0 {_hasState_(X,Y,"t"):const(Y)} 3:-s11_(X,"t*") .
(C-1) {_hasState_(X,Y,"f"):_hasState_(X,Y,"t*");s12_(Y,"f"):_hasState_(X,Y,"t*"),not _hasState_(X,Y,"f")} (C-1):-s11_(X,"f"),#count {Y:_hasState_(X,Y,"t*")}=C,C>1 .
_hasState_(X,Y,"f"):-s11_(X,"f"),_hasState_(X,Y,"t*"),_hasState_(X,Y,"f") .
2 {s12_(Y,"t*"):_hasState_(X,Y,"t**")} 3:-s11_(X,"t*") .


s13_(X,"t*"):-node1hgvtqvi9x137_(X,"t*") .
s14_(X,"f"):-s13_(X,"t*") .
s14_(X,"t*"):-s13_(X,"f") .
...
s8_(X,"f");s10_(X,"f");s13_(X,"f"):-node1hgvtqvi9x137_(X,"f") .
s17_(X,"t*"):-_obligationStateShape_(X,"t*") .
node1hgvtqvi9x137_(X,"t*"):-s17_(X,"t*") .
node1hgvtqvi9x137_(X,"f"):-s17_(X,"f") .

s18_(X,"t*"):-node1hgvtqvi9x137_(X,"t*") .
...
s27_(X,"t*"):-node1hgvtqvi9x137_(X,"t*") .
s28_(X,"f"):-s27_(X,"t*") .
s28_(X,"t*"):-s27_(X,"f") .
...
s18_(X,"f");s27_(X,"f"):-node1hgvtqvi9x137_(X,"f") .
