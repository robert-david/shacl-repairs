...
d_hasState("d_ob_9e2bb1ce_2ed4_11ed_be7d_3f8589292a29","d_UnknownState") .
...
bnode_node1i7lkib3nx127_(X,"t*"):-s0_(X,"t*") .
bnode_node1i7lkib3nx127_(X,"f"):-s0_(X,"f") .

% sh:maxCount 1 for bnode_node1i7lkib3nx127
s1_(X,"t*"):-bnode_node1i7lkib3nx127_(X,"t*") .
s2_(X,"f"):-s1_(X,"t*") .
s2_(X,"t*"):-s1_(X,"f") .
d_hasState_(X,@new(s2,X,d_hasState,1..1),"t"):-choose(s2,X,d_hasState,1) .
d_hasState_(X,@new(s2,X,d_hasState,1..2),"t"):-choose(s2,X,d_hasState,2) .
choose(s2,X,d_hasState,2);choose(s2,X,d_hasState,1);choose(s2,X,d_hasState,0):-s2_(X,"t*") .
0 {d_hasState_(X,Y,"t"):const(Y)} 3:-s2_(X,"t*") .
(C-1) {d_hasState_(X,Y,"f"):d_hasState_(X,Y,"t*");s3_(Y,"f"):d_hasState_(X,Y,"t*"),not d_hasState_(X,Y,"f")} (C-1):-s2_(X,"f"),#count {Y:d_hasState_(X,Y,"t*")}=C,C>1 .
d_hasState_(X,Y,"f"):-s2_(X,"f"),d_hasState_(X,Y,"t*"),d_hasState_(X,Y,"f") .
2 {s3_(Y,"t*"):d_hasState_(X,Y,"t**")} 3:-s2_(X,"t*") .


% sh:minCount 0 for bnode_node1i7lkib3nx127
s4_(X,"t*"):-bnode_node1i7lkib3nx127_(X,"t*") .
choose(s4,X,d_hasState,0):-s4_(X,"t*") .
...
0 {s5_(Y,"t*"):d_hasState_(X,Y,"t**")} 3:-s4_(X,"t*") .


% universal for bnode_node1i7lkib3nx127
s6_(X,"t*"):-bnode_node1i7lkib3nx127_(X,"t*") .
s7_(X,"f"):-s6_(X,"t*") .
s7_(X,"t*"):-s6_(X,"f") .
...
0 {d_hasState_(X,Y,"t"):const(Y)} 3:-s7_(X,"t*") .
...
1 {s8_(Y,"t*"):d_hasState_(X,Y,"t**")} 3:-s7_(X,"t*") .
s9_(X,"f"):-s8_(X,"t*") .
s9_(X,"t*"):-s8_(X,"f") .


s1_(X,"f");s4_(X,"f");s6_(X,"f"):-bnode_node1i7lkib3nx127_(X,"f") .
s10_(X,"t*"):-d_ObligationStateShape_(X,"t*") .
bnode_node1i7lkib3nx127_(X,"t*"):-s10_(X,"t*") .
bnode_node1i7lkib3nx127_(X,"f"):-s10_(X,"f") .

% sh:minCount 1 for bnode_node1i7lkib3nx127
s11_(X,"t*"):-bnode_node1i7lkib3nx127_(X,"t*") .
d_hasState_(X,@new(s11,X,d_hasState,1..1),"t"):-choose(s11,X,d_hasState,1) .
choose(s11,X,d_hasState,1);choose(s11,X,d_hasState,0):-s11_(X,"t*") .
0 {d_hasState_(X,Y,"t"):const(Y)} 3:-s11_(X,"t*") .
(C-0) {d_hasState_(X,Y,"f"):d_hasState_(X,Y,"t*");s12_(Y,"f"):d_hasState_(X,Y,"t*"),not d_hasState_(X,Y,"f")} (C-0):-s11_(X,"f"),#count {Y:d_hasState_(X,Y,"t*")}=C,C>0 .
d_hasState_(X,Y,"f"):-s11_(X,"f"),d_hasState_(X,Y,"t*"),d_hasState_(X,Y,"f") .
1 {s12_(Y,"t*"):d_hasState_(X,Y,"t**")} 3:-s11_(X,"t*") .


s13_(X,"t*"):-bnode_node1i7lkib3nx127_(X,"t*") .
s14_(X,"f"):-s13_(X,"t*") .
s14_(X,"t*"):-s13_(X,"f") .
...
s11_(X,"f");s13_(X,"f"):-bnode_node1i7lkib3nx127_(X,"f") .
s17_(X,"t*"):-d_ObligationStateShape_(X,"t*") .
bnode_node1i7lkib3nx127_(X,"t*"):-s17_(X,"t*") .
bnode_node1i7lkib3nx127_(X,"f"):-s17_(X,"f") .

s18_(X,"t*"):-bnode_node1i7lkib3nx127_(X,"t*") .
...
s27_(X,"t*"):-bnode_node1i7lkib3nx127_(X,"t*") .
s28_(X,"f"):-s27_(X,"t*") .
s28_(X,"t*"):-s27_(X,"f") .
...
s18_(X,"f");s27_(X,"f"):-bnode_node1i7lkib3nx127_(X,"f") .
s0_(X,"f");s10_(X,"f");s17_(X,"f"):-d_ObligationStateShape_(X,"f") .
